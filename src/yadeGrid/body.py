...
@define
class Quaternion:
    a: float = field(default=1.0)   # Real part of the quaternion
    b: float = field(default=0.0)   # First imaginary part of the quaternion
    c: float = field(default=0.0)   # Second imaginary part of the quaternion
    d: float = field(default=0.0)   # Third imaginary part of the quaternion
...
class Body:
    ...
    inertia: Vector3D  = field(default=np.array([0,0,0]))         # Diagonal inertia tensor of the body
